...
const COLUMNS = [
    { label: "Sr.",           width: "50px"                                                                    },
    { label: "Manufacturer",  maxWidth: "70px", key: "make",  className: "fw-normal text-center px-2"         },
    { label: "Model",         maxWidth: "70px", key: "model", className: "fw-normal text-center px-2"         },
    { label: "Installations", width: "80px",    render: row => row.count.toLocaleString(), className: "fw-semibold text-dark" },
];

const Top5MakeModelTable = ({ range, customParams = {} }) => {
